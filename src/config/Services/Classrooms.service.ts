...
export const ApiClassrooms = {
  getAll: (): Promise<IClassroom[]> => ApiRequest({ url: "/classes", method: "GET" }),
  getById: (id: number): Promise<IClassroom> => ApiRequest({ url: `/classes/${id}`, method: "GET" }),
  ...
  delete: (id: number): Promise<{ message: string }> =>
    ApiRequest({ url: `/classes/${id}`, method: "POST", body: {_method: "DELETE"} }),
};