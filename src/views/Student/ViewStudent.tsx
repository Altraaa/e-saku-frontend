...
const ViewStudent = () => {
  ...
  const teacherId = classrooms?.[0]?.teacher?.id || "";
  ...
  return (
    <>
      <div className="flex flex-col items-start gap-2 lg:flex-row lg:justify-between lg:items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-2 w-full lg:w-auto">
          <Dialog open={isAddClassModalOpen} onOpenChange={(open) => {
              ...
              <div className="grid gap-4 py-4">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">Classes will be assigned to the current teacher automatically</p>
                  </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  ...
                  <ul className="text-xs text-gray-600 space-y-1">
                    <li className="flex items-start">
                      ...
                      <span>Class name should follow format: Grade + Program + Number (e.g., XI TKR 1)</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-1">•</span>
                      <span>Description should include program details and academic year</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-1">•</span>
                      <span>Teacher assignment is automatic based on current user</span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-1">•</span>
                      <span>Students can be added to the class after creation</span>
                    </li>
                  </ul>
                </div>
