                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="space-y-2 flex-1">
                    ...
                    <Select value={classType} onValueChange={setClassType}>
                      ...
                      <SelectContent>{classroomOptions}</SelectContent>
                    </Select>
                    {errors.classType && (
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                      <div className="space-y-2 flex-grow">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="rambut-panjang">
                              Rambut Panjang
                            </SelectItem>
                            <SelectItem value="terlambat">Terlambat</SelectItem>
                            <SelectItem value="tidak-seragam">
                              Tidak Berseragam
                            </SelectItem>
                        ...
                        <Label htmlFor="point" className={labelClass}>
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p className="text-xs">
                                  Poin dihitung otomatis berdasarkan tingkatan
                                  prestasi
                                </p>
                              </TooltipContent>
                            </Tooltip>
              ...
              <>
                {inputType === "violation" ? (
                  <div className="bg-green-50 p-4 rounded-lg border-2 border-green-200">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        <Label htmlFor="followUpType" className={labelClass}>
                          <ArrowRight className={greenIconClass} />
                          Pilih Tindak Lanjut{" "}
                          <span className="text-red-500">*</span>
                        </Label>
                        <Select
